...
exports.forLoopRecursive = exports.forEachRecursive = exports.forRecursive = exports.mapRecursive = void 0;
/**
...
var mapRecursive = function (data, mapperFn, nestedKey) {
    ...
    return data.map(function (item) {
        ...
        if (Array.isArray(nestedValue)) {
            return __assign(__assign({}, mapperFn(item)), (_a = {}, _a[nestedKey] = (0, exports.mapRecursive)(nestedValue, mapperFn, nestedKey), _a));
        }
